""" Пакет содержит алгоритм для нахождения наименьшей окружности
Источник https://www.nayuki.io/page/smallest-enclosing-circle """
...
def make_circle(points):
    ...
    center = np.array([np.array(c[0]), np.array(c[1])])
    radius = c[2]
